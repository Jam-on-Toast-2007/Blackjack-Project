...
- **Play** — if you already have a profile selected, this jumps straight back into it. If you don't have a profile yet (or haven't picked one this session), **Play** instead starts an instant guest practice session with a fresh $1,000 bankroll and the Training preset's rules — no profile is created, and the hands you play aren't saved or tracked anywhere. It's the fastest way to just try the table out. If you later want your progress tracked, back out and create a profile instead.
